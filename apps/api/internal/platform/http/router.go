...
type Handlers struct {
	...
	WorkerPreferences      http.HandlerFunc
	WorkerDigestCandidates http.HandlerFunc
	WorkerNotificationSent http.HandlerFunc
...
func NewRouter(h Handlers) http.Handler {
	...
	mux.HandleFunc("/api/worker/notifications/sent", h.WorkerNotificationSent)
